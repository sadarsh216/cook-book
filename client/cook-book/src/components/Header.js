              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  ...
                  <img
                    ...
                    alt="Workflow"
                    />
                    <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate ml-5">Cook Book</h2>
                </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-indigo-900 text-white' : 'text-gray-600  hover:text-indigo-600',
