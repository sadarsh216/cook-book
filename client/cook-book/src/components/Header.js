                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex-shrink-0 flex items-center">
                    ...
                    <img
                      ...
                      alt="Workflow"
                    />
                    <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate ml-5">
                      Cook Book
                    </h2>
                  </div>
                  ...
                  {login ? (
                    <>
                      ...
                      <Menu as="div" className="ml-3 relative">
                        <div>
                          <Menu.Button className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white hover:ring-offset-indigo-600">
                    ...
                    <>
                      <button
                        ...
                        type="button"
                        className="px-3 py-2 rounded-md text-sm font-medium bg-indigo-600 text-white hover:text-white"
                      >
                        Login
                      </button>
                    </>
